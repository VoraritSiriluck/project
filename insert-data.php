...
if (isset($_REQUEST['btn_report'])) {
    ...
    if (empty($reporter_name)) {
        ...
        try {
                ...
                $insert_stmt->bindParam(':reporter_name', $reporter_name);
                $insert_stmt->bindParam(':reporter_fullname', $reporter_fullname);
                $insert_stmt->bindParam(':position', $position);
                $insert_stmt->bindParam(':report_date', $report_date);
                $insert_stmt->bindParam(':room', $room);
                $insert_stmt->bindParam(':detail', $detail);
                $insert_stmt->bindParam(':image_name', $newname);
                $insert_stmt->bindParam(':fiscal_year', $fiscal_year);
